...
$query = $db->query("SELECT veriler.cinsiyet,COUNT(veriler.cinsiyet) as asd from veriler GROUP BY veriler.cinsiyet");
?>
 ...
 <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        // Set chart options
        var options = {title:'Cinsiyet Oranı',
                       width:640,
                       height:400,
