...
$query1 = "SELECT cinsiyet FROM veriler GROUP BY cinsiyet";
...
function load_monthwise_data(cinsiyet, title)
{
    var temp_title = title + ' '+cinsiyet+'';
    $.ajax({
        url:"fetch13.php",
        method:"POST",
...
function drawMonthwiseChart(chart_data, chart_main_title)
{
    ...
    ticks: [0, 20000, 40000, 60000, 80000] // display labels every 25
}
...
<li><a href="gelirsehir">Şehirler</a></li>
 ...
 <p>Cinsiyete Göre Aylık Gelir</p>
 <section class="anadiv">
<div class="div2">
<select name="cinsiyet" class="form-control" id="cinsiyet" style="
...
padding: 3px;">
                            ...
                            {
                                echo '<option value="'.$row1["cinsiyet"].'">'.$row1["cinsiyet"].'</option>';
                            }
                            ?>
                            </select> 
