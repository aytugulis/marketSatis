...
$query = $db->query("SELECT veriler.tarih,sum(round(veriler.vergisizGelir)) as asd FROM veriler GROUP BY veriler.tarih ORDER BY asd desc");
?>
...
<html lang="tr" dir="ltr">
 ...
 <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    ...
    ticks: [00000, 20000, 40000, 60000, 80000, 100000 ,120000] // display labels every 25
}
